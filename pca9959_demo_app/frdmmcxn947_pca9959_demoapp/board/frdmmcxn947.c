...
gpioHandleKSDK_t D9 = {.base = GPIO0, .pinNumber = 10, .mask = 1 << (10), .clockName = kCLOCK_Gpio0, .portNumber = 0};
gpioHandleKSDK_t D8 = {.base = GPIO0, .pinNumber = 28, .mask = 1 << (28), .clockName = kCLOCK_Gpio0, .portNumber = 0};
